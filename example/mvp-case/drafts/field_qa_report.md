...
| tasa-790-038 | Epígrafe / autoliquidación | ⚠️ MISSING | обязательное поле пусто в профиле · реестр: выбрать верный эпиграф; сумма меняется — проверить вживую. Код 038 (НЕ 052): авторизацию по Ley 14/2013 резолвит UGE-CE |
...
| tasa-790-012 | Epígrafe / autoliquidación (TIE) | ⚠️ MISSING | обязательное поле пусто в профиле · реестр: RENOVACIÓN и primera concesión — РАЗНЫЕ строки с разными суммами; подставленная формой сумма — способ проверить, что выбрана нужная строка |
