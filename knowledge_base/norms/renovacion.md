...
>
> 🔎 **Сверка с новым регламентом (2026-07).** Базовый принцип продления —
> **art. 74 quinquies Ley 14/2013**, закон: замена RD 557/2011 → **RD 1155/2024**
> его не двигает. Единственное место в файле, которое реально живёт в регламенте —
> **лимиты отсутствия** в строке «Пребывание/адрес»; они здесь намеренно не
> названы числом и помечены «(проверить вживую)». Перечень документов не
> пересверялся — as-of остаётся **2026-06**.
