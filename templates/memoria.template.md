...
<!-- ═══════════════════════════════════════════════════════════════════════
     ...
     Канон: knowledge_base/norms/solicitud-inicial.md §5 (кто подписывает
     и кто подаёт; разбор NIE, представителя, паспорта).

     1) ДОКУМЕНТ подписывает САМ ЗАЯВИТЕЛЬ, не представитель.
        Представитель подписывает ОТПРАВКУ (электронную подачу своим
        сертификатом). Это два разных действия.

     2) БЕЗ NIE — блок выше НЕ ГОДИТСЯ (строка `N.I.E. {{NIE}}` даст
        пустое место). ЗАМЕНИТЬ блок подписи на вариант Б:
     ...
     3) ЕСЛИ ПОДАЁТ ПРЕДСТАВИТЕЛЬ — добавить ПОСЛЕ подписи заявителя
        отдельный блок, не вместо неё:
